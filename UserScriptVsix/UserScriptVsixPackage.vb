...
<Guid(UserScriptVsixPackage.PackageGuidString)>
Public NotInheritable Class UserScriptVsixPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "eeb7863f-bf7e-4647-8eb0-65495723e9cf"
